package com.game.student.Tools;/* Copyright by Johannes Borchardt */
...
public class GifDecoder {
    ...
    public class GIFAnimation {
        ...
        public Animation<TextureRegion> rebuildAnimation(float frameDuration, Animation.PlayMode playMode) {
    ...
    public GIFAnimation getAnimation(Animation.PlayMode playType) {
        ...
        GIFAnimation result = new GIFAnimation(target, playType.ordinal(), nrFrames, hzones, vzones, width, height, getDelay(0));

        return result;
    }

    public static GIFAnimation loadGIFAnimation(Animation.PlayMode playType, InputStream is) {
